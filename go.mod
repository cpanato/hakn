module github.com/chainguard-dev/hakn
...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/k8schain v0.0.0-20221017135236-9b4fdd506cdd // indirect
	...
	knative.dev/control-protocol v0.0.0-20230120194803-cffe2086fdab // indirect
